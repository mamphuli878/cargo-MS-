package com.cargoapp.controller.datastructure;
...
public class CustomQueue {
    ...
    private LinkedList<CargoModel> vivaList; // Internal storage for the queue.
     ...
     * queue is full.
     */
    public int enQueue(CargoModel studentModel) {
        if (isFull()) {
